...
public class ComplexRename {
        ...
        while (count < listOfFilesToBeRenamed.length - 1) {
            ...
            while (counter < Rename.getLength(student)) {
                ...
                try {
                    ...
                    if (!listOfFilesToBeRenamed[count].contains("assignsubmission")
                            && !secondSplitList[0].contains("-60") && aStudentFileToRename.getAttendanceStatus()) {
    ...
    public String[] getListOfFilesToBeRenamed(){
        return ComplexRename.listOfFilesToBeRenamed;
    }
    
    public int getNumeral(){
        return ComplexRename.numeral;
    }
